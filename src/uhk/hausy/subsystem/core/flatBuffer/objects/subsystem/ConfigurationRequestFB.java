...
public class ConfigurationRequestFB extends Table {
  ...
  public int subsystemId() { int o = __offset(4); return o != 0 ? bb.getInt(o + bb_pos) : -1; }
  ...
  public static void addSubsystemId(FlatBufferBuilder builder, int subsystemId) { builder.addInt(0, subsystemId, -1); }
